...
`mappings/model-classes.json` on 2026-09-02 11:13 CEST; re-run it rather than editing the table.
...
| `model-qwen-qwen3.5-397b-a17b-or-c1-2026-09-02` | qwen/qwen3.5-397b-a17b | openrouter | 1 | allowed | IN PROGRESS 44/66 | 5 / 8 seen | 3 / 3 (2 not adjudicated) | 2 | 43 | 1.13 |

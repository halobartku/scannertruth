...
`mappings/model-classes.json` on 2026-09-02 09:39 CEST; re-run it rather than editing the table.
...
| `model-qwen-qwen3.5-397b-a17b-or-c1-2026-09-02` | qwen/qwen3.5-397b-a17b | openrouter | 1 | allowed | IN PROGRESS 23/66 | 3 / 4 seen | 3 / 3 | 1 | 23 | 0.735 |

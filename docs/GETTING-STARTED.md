...
python test_all.py        # 171 checks on the code that produces every published figure
...
**What you should see.** `test_all.py` ends with `171 passed, 0 failed`. `verify.py` prints a table

...
```bash
python test_all.py     # 113 checks, mutation-verified; expect "113 passed, 0 failed"
```
...
`control-noisy` flags every non-empty line: 931 findings on corpus 1, 1,413,620 on corpus 2, and

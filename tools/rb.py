...
CORPUS = "/tmp/sealevel-attacks/programs"
...
MAP = {
    ...
    "6-duplicate-mutable-accounts": [],                       # NO RULE EXISTS
    ...
    "9-closing-accounts":           [],                       # NO RULE EXISTS
    "10-sysvar-address-checking":   [],                       # NO RULE EXISTS
}

...
| `radar-c2-2026-09-01/`, `vaultlint-c2-2026-09-01/`, `semgrep-solana-standard-2026-09-01/`, `solsec-2026-09-01/`, `solazy-2026-09-01/`, `sol-audit-v3-2026-09-01/` | hand-driven per-case scripts on 2026-09-01; the Radar one was turned into `c2-radar-current.json` and its log by `tools/legacy/normalise_runs.py`, since replaced by the `-fw` re-run; the VaultLint one is still the source of `c2-vaultlint-complete.json` | flat `<case>.<variant>.<ext>` files, or `c1/` and `c2/` subdirectories of them; `sol-audit-v3-2026-09-01/c1/<case>.<variant>.<profile>.{json,log,filelog}` carries the profile in the name |

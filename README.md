...
11 on the corpus the whole field measures against scores **0 out of 16** here.
    ...
    python test_all.py                        # 166 checks, no dependencies
...
**Two dials, and they answer different questions.** `selfcheck` says the machinery is sound: 166
...
- **166 checks**, mutation-verified: deliberate defects were introduced and caught, including one
...
- **[47 of our own errors](docs/ENGINEERING-LOG-2026-09-04.md), with dates**, including a headline we
...
test_all.py            166 checks, mutation-verified. Run this first
...
docs/
  ...
  ENGINEERING-LOG-*.md our errors, with dates: 20 on 2026-08-31, 20 more on 2026-09-01, 4 on 2026-09-02, 3 on 2026-09-03, 0 on 2026-09-04 (numbered to 48; 9 never issued)

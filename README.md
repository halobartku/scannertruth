...
11 on the corpus the whole field measures against scores **0 out of 16** here.
    ...
    python test_all.py                        # 171 checks, no dependencies
...
**Two dials, and they answer different questions.** `selfcheck` says the machinery is sound: 171
...
- **171 checks**, mutation-verified: deliberate defects were introduced and caught, including one
...
test_all.py            171 checks, mutation-verified. Run this first
